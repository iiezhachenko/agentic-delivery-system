...
- **Failure mode this closes:** agent narrates "tests pass / it works" from its own run → human trusts an unverified or cherry-picked result. Fix: agent supplies the runnable steps; human runs them; nothing is "verified" until the human ran it.
