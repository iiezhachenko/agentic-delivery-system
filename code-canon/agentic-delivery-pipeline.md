...
- **Both-directions discrimination is mandatory:** known-good PASS + planted-defect FAIL, proving the verifier discriminates before any self-build is trusted.
