...
escapes:
  ...
  - { when: "manifest/aPRD/cut class lacks authored playbook (refactor|migration|perf|integration|investigation) — brownfield inheritance/conformance reconciliation not authored (D7, D10)", target: "that playbook / HALT, report class" }
