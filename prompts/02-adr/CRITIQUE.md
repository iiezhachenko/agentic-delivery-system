...
inputs:
  ...
  - { path: ".aprd/aprd.frozen.md", format: "markdown — frozen contract; trace + coverage oracle: real id-space every ADR trace resolves into + CONSTRAINTS C* bounding coverage check" }
