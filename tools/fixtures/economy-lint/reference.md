...
# Role: REF-EXAMPLE
Example planner, Phase 4. One thing: filter frozen DAG to skeleton path, classify seams. Lane: ordered units only; code/oracle/verify own later stages.
...
- Clean run → write .build/skeleton/ref.json, state units ordered, next stage, stop.
