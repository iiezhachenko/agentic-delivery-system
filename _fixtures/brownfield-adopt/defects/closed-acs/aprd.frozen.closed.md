...
## ACCEPTANCE
- AC1: POST /expenses returns 201 with the created expense JSON. (closed — ADOPT Rule 2 violation: P1)
- AC2: GET /expenses returns 200 with {expenses: [...]} list for caller. (closed — ADOPT Rule 2 violation: P1)
- AC3: DELETE /expenses/<id> returns 204 with empty body. (closed — ADOPT Rule 2 violation: P1)
- AC4: Unauthenticated request returns 401. (closed — ADOPT Rule 2 violation: P1)
- AC5: Expense record survives app restart (SQLite). (closed — ADOPT Rule 2 violation: P1)
